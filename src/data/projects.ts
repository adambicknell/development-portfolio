...
export const projects: DemoProject[] = [
  ...
  },
  {
    ...
    status: "Planned",
    summary:
      "A workflow dashboard demo for issue intake, support triage, priority handling, status changes, comments, admin review, and dashboard metrics.",
    problem:
      "Internal teams need a structured way to capture issues, categorise work, prioritise requests, assign ownership, and track status without relying on scattered messages.",
    features: [
      "Issue intake",
      "Status workflow",
    ...
    decisions: [
      ...
      "Track actions for supportability",
    ],
    improvements: [
      "Notification rules",
